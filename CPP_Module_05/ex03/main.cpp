...
/*   Updated: 2024/12/13 14:10:53 by sylabbe          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    AForm* shruberry = drunge.makeForm("shrubbery creation", "forest");
    AForm* robotomy = drunge.makeForm("robotomy request", "Corrector");
    AForm* presidentialpardon = drunge.makeForm("presidential pardon", "forest");
    std::cout << std::endl;
